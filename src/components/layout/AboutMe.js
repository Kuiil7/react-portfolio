...
<p className="title mt-4 is-size-4 fade-in-2">Inclusion.</p>
...
<p className="title mt-4 is-size-4 fade-in-1">Flexibility.</p>
...
const mainContainer =   <section className="hero  is-fullheight" id="AboutMeSection">
