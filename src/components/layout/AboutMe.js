...
const AboutMe = () => {
 ...
 <img src={Portrait_5} alt="self-portrait"  className="box p-1"  />
  ...
  <h1 className="subtitle is-6 mt-6 "><span className="title is-size-4 has-text-weight-bold fade-in-3 ">    Jose Aguilera Merino</span>
<br />
...
<div className="column">
<h1><span className="title mt-4 is-size-4 fade-in-2 mb-1">Accessibility. </span>
<br/>
...
<div className="columns px-4">
<div className="column">
<h1><span className="title mt-4 is-size-4 fade-in-2 mb-1">Inclusion. </span>
<br/>
<span className="fade-in-3">
...
<div className="columns px-4">
<div className="column">
<h1><span className="title mt-4 is-size-4 fade-in-2 mb-1">Flexibility. </span><br/>
<span className="fade-in-3">
...
<br/>
<span>
It is in fusing my linguistic and technical background that I create and innovate with the goal to make the world a more accessible and inclusive place for all.
</span>
</h1>
</div>
<div className="column is-4">
