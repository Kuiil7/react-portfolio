...
function AboutMe() {
  ...
  const Bio =   <div className="has-text-justified  box" style={{ backgroundColor: 'rgba(52, 52, 52, 0.8)'}}>
...
const mainContainer =   <section className="hero is-info is-fullheight" id="AboutMeSection">
